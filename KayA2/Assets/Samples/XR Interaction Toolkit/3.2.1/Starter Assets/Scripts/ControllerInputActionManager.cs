...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class ControllerInputActionManager : MonoBehaviour
    {
        ...
        public InputActionProperty shrinkAction; // to be assigned to B
        public InputActionProperty growAction;   // to be assigned to U

        public bool Shrink()
        {
            return shrinkAction.action.WasPressedThisFrame();
        }

        public bool Grow()
        {
            return growAction.action.WasPressedThisFrame();
        }
        ...
        protected void OnEnable()
        {
            ...
            //input disabling code for shrink and grow
